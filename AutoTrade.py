...
slack = Slacker('xoxb-2278717409559-2293667016579-04GWI7VK2SQ1B7hPtrzj2SPX')
def dbgout(message):
    """인자로 받은 문자열을 파이썬 셸과 슬랙으로 동시에 출력한다."""
    print(datetime.now().strftime('[%m/%d %H:%M:%S]'), message)
    strbuf = datetime.now().strftime('[%m/%d %H:%M:%S] ') + message
    #slack.chat.post_message('#1', strbuf)
    post_message(myToken,"#1",strbuf)
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A291680', 'A138910', 'A252670', 'A252710', 'A133690']
